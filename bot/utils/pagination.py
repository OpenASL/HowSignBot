# Adapted from https://github.com/python-discord/bot/blob/7bc390ed20bda22cf5a2b455be6d4b15eedf47c0/bot/exts/utils/extensions.py
import asyncio
import logging
import typing as t
    ...
    * max_lines: `int`
    ...
    async def paginate(
        ...
        def event_check(reaction_: discord.Reaction, user_: discord.Member) -> bool:
            ...
            no_restrictions = user_.id == restrict_to_user.id
